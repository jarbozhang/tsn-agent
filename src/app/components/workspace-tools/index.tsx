...
import { Copy, FolderOpen, Plus, ScrollText, Settings, Trash2, Wrench, X } from "lucide-react";
...
import { releaseNotes, type ReleaseNote } from "../../../release/release-info";
...
export function WorkspaceToolDrawer({
  activePanel,
  currentSession,
